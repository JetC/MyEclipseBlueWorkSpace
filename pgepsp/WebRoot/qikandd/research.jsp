...
<div>搜索结果</div>
  <div>
    <a href="/pgepsp/qkdd/pr">查看所有</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pgepsp/qkdd/prform" target="down_frame">添加新的文章导读</a>
    &nbsp;&nbsp;&nbsp;&nbsp;<a href="/pgepsp/qkdd/research">刷新页面</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pgepsp/qkdd/pc" target="down_frame">管理种类</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pgepsp/qkdd/po" target="down_frame">管理文章来源</a> 
<div class="research">
<ul>
...
<div>
  ...
  <div style="display: inline;" id="page"><ul>
	<li><a href="<s:url value="%{researchType}"><s:param name="key" value="%{key}"/><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">第一页</a></li>
	<li><a href="<s:url value="%{researchType}"><s:param name="key" value="%{key}"/><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">上一页</a></li>
	<li><a href="<s:url value="%{researchType}"><s:param name="key" value="%{key}"/><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">下一页</a></li>
	<li><a href="<s:url value="%{researchType}"><s:param name="key" value="%{key}"/><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">尾页</a></li>
	<li>共<s:property value="pager.maxPages"/>页</li>
	<li>当前是第<s:property value="pager.currentPage"/>页</li>
	<li><form action="<s:url value="%{researchType}"></s:url>" method="post" id="gotoform">
	...
	<input type="button" value="go" onclick="toPage()"/></form></li></ul>
  </div>
  
  <!--  
   <div class="iframe">
  <iframe width="800" height="800" name="framecontent" frameborder="0" src="/pgepsp/qkdd/prxq"></iframe>
  </div>
  -->
