...
<img src="images/hyjy.png" width="791px" height="49px"/>
<div class="hbsy_add_div1"><ul>
<s:form action="hyjy_add"  target="_blank" onsubmit="return check_hyjyadd(this)"  method="post" enctype="multipart/form-data">
<s:token/>
<table>
<tr><td>活动主题:</td><td><input type="text" name="m_title"  value="" id="hyjy_m_title" size="78"/></td></tr>
<tr><td valign="top">活动摘要:</td><td><textarea name="m_abstract"   cols="60" rows="5"></textarea></td></tr>

<tr><td valign="top">活动详细说明:</td><td><textarea name="m_detail"  id="hyjy_m_detail"  cols="60" rows="20"></textarea></td></tr>
<tr><td>活动的分类:</td><td><input type="text"  name="m_type"  value="默认分类" id="hyjy_m_type"/></td></tr>
<tr><td><s:select list="%{str1}" label="分类选择" onchange="javascript:change_hyjy_type()" id="select_types"></s:select></td></tr>
