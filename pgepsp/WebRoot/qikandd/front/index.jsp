		...
		<table width="1024" border="0">
			<tr>
				...
				<br/>
					...
					<a class="two" href="<s:url value="/qkdd/fclass"><s:param name="key" value="%{'国际环保'}"/></s:url>">国际环保</a> 
					<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
					src="images/hbsy_head.png" width="20px" height="20px" />
					<a class="two" href="<s:url value="/qkdd/fclass"><s:param name="key" value="%{'节能环保'}"/></s:url>">节能环保</a>
					<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
					src="images/hbsy_head.png" width="20px" height="20px" />
					<a class="two" href="<s:url value="/qkdd/fclass"><s:param name="key" value="%{'工程'}"/></s:url>">工程</a>
					<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
					src="images/hbsy_head.png" width="20px" height="20px" />
					<a class="two" href="<s:url value="/qkdd/fclass"><s:param name="key" value="%{'热点'}"/></s:url>">热点</a>
					</td>
					 ...
					 <a style="font-size: 12px;color: #0099ee" href="/pgepsp/qkdd/findex">电子报纸与期刊导读</a>
							...
							<tr><td colspan="5"><hr color="#006600"/></td></tr>
							 <s:iterator value="pubReaList">
								...
								<td align="right" colspan="3"><span style="color:006600;font-weight:bold;font-size:14px;">
								[<s:property value="p_from"/>][<s:property value="p_type"/>]</span>
								...
								<a href="<s:url value="/qkdd/fdetail">
 								 		...
 								 		</s:url>"><s:property value="p_preread" escapeHtml="false"/></a></span></td>
								</tr>
							</s:iterator>
							<tr>
								<td colspan="4" align="right">
									<table class="hbsy_table2">
										<tr>
											...
											<td width="30px"></td>
											<td bgcolor="#DCD9D4"><a href="<s:url value="/qkdd/findex"><s:param name="method" value="%{'first'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">首页</a>
											</td>
											<td bgcolor="#DCD9D4"><a href="<s:url value="/qkdd/findex"><s:param name="method" value="%{'back'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">上一页</a>
											</td>
											<td bgcolor="#EBEBEA">&nbsp;<s:property
													value="pager.currentPage" />&nbsp;</td>
											<td bgcolor="DCD9D4"><a href="<s:url value="/qkdd/findex"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">下一页</a>
											</td>
											<td align="left"><div class="hbsy_div1">
													<ul>
														<li>	
														<form action="/pgepsp/qkdd/findex" method="post" id="gotoform">
											...
											<td width="24px"></td>
											<td bgcolor="#DCD9D4">	<a href="<s:url value="/qkdd/findex"><s:param name="method" value="%{'last'}"/><s:param name="pager.currentPage" value="pager.currentPage"/></s:url>">尾页</a>
											</td>
										</tr>
									</table>
								</td>
