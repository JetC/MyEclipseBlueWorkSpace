...
<%
	...
	if (pageNum == null || count == null) {
		response
				.sendRedirect("pictureListAction.action?pageNum=0");
		return;
	}
	if (keyword == null) {
		keyword = "";
					...
					<td width="800" rowspan="3" valign="top">
						...
						<div id="hbsy">
							<table class="hbsy_table1" width="800px">
									...
									<td colspan="4" valign="middle" align="right">
										<div id="hbsy_search">
											<ul>
												<li>
													<form method="get"
														action="picture/pictureListAction.action">
								...
								<tr height="300px">
									<td>
										<img src="picture/pictureGetAction.action?id=<%=id%>" height="400px" width="300px" />
										<br />
										<a href="picture/showPicture.jsp?id=<%=id%>">查看详细</a>
									</td>
								</tr>
								<%
									}
									out
											.println("<a href=\"picture/pictureListAction.action?pageNum=0&keyword="
													+ keyword + "&count=" + count + "\">首页</a>");
									if (pageNum > 0) {
										out
												.println("<a href=\"picture/pictureListAction.action?pageNum="
														+ (pageNum - 1)
														+ "&keyword="
														+ keyword
														+ "&count=" + count + "\">上一页</a>");
									...
									out.println("<a href=\"picture/pictureListAction.action?pageNum="
