...
function getLookingTime(){
	...
	xmlHttp.open("POST","hbsy/hbsy_sta",true);
  ...
  <script language="javascript" src="js/hbsy.js"></script><center>
...
<div style="margin-bottom: 0;">
		<table width="750px">
			<tr height="49px">
				<td valign="middle"
					style="background:url(hbsy/images/hbsy.png) no-repeat  " align="right">您现在的位置:首页&gt;
					环保术语</td>
			</tr>
			<tr>
				<td align="center"><h1>
						<s:property value="h.e_name" />
					</h1>
				</td>
			</tr>
			<tr>
				<td bgcolor="#F7F7F7" align="center">作者:管理员&nbsp;发布于:${dateString}&nbsp;类型:<s:property value="h.e_type" />&nbsp;浏览次数:<s:property
			...
			<tr>
				<td width="750" valign="top"><label
					...
					<div id="hbsy_id1">
						<img
							src="<s:url value="hbsy/hbsy_pic_look"><s:param name="id" value="h.id"/></s:url>"
							width="320" height="210" border="0" />
						<s:property value="h.e_detail" />
					</div> <br /></td>
			</tr>
