				...
				<tr>
					...
					<td width="800" rowspan="3" valign="top" align="center">
						...
						<div style="margin-bottom: 0;">
							<form method="post" action="video/videoAction.action"
								...
								<table width="750px">
									...
									<tr>
										<td>
											文件：
											<input type="file" name="videoVo.video" />
										</td>
									</tr>
									<tr>
										<td>
											标题：
											<input type="text" name="videoVo.title" />
										</td>
									</tr>
									<tr>
										<td>
											描述：
											<input type="text" name="videoVo.descirbe" />
										</td>
									</tr>
									<tr>
										<td>
											地点：
											<input type="text" name="videoVo.place" />
										</td>
									</tr>
									<tr>
										<td>
											人物：
											<input type="text" name="videoVo.person" />
										</td>
									</tr>
									<tr>
										<td>
											类型：
											<input type="text" name="videoVo.type" />
										</td>
									</tr>
									<tr>
										<td>
