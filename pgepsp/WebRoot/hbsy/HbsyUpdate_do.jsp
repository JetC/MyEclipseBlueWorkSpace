...
<base href="<%=basePath%>">
  ...
  <img src="images/hbsy.png">
    <s:form action="/hbsy/hbsy_update_do" target="_blank" method="post" enctype="multipart/form-data">
...
<tr><td>术语的分类:</td><td><input type="text"  name="e_type"  value="" id="hbsy_e_type"/></td></tr>
