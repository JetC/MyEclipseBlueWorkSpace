...
<html>
  ...
  <body><center><jsp:include page="../head.jsp"/>
    <div id="hbsy">
<table class="hbsy_table1" >
<tr height="49px"><td colspan="4" valign="middle" style="background:url(hyjy/images/hyjy.png) no-repeat;  " align="right">您现在的位置:首页 &gt; 环保术语</td></tr>
...
<tr><td colspan="4"><h1>重要会议纪要检索结果:共有${num}条结果</h1></td></tr>
<tr height="18px"><td></td><td style="border-bottom: 1px dotted #00FF00;">重要会议纪要主题</td><td align="center" style="border-bottom: 1px dotted #00FF00;">浏览量</td><td align="center" style="border-bottom: 1px dotted #00FF00;">创建时间</td>
</tr>
<s:iterator value="allList">
<tr height="18px" ><td width="50px" ></td>
					   <td width="500px" style="border-bottom: 1px dotted #00FF00;"><img src="hyjy/images/hyjy_head.png" width="20px" height="20px"><a href="<s:url value="hbsy_look.action">
...
<td bgcolor="DCD9D4"><a href="<s:url value="hbsy_search"><s:param name="method" value="%{'next'}"/><s:param name="pager.currentPage" value="pager.currentPage"/><s:param name="word" value="word"/><s:param name="keyword" value="keyword"/></s:url>">下一页</a></td>
